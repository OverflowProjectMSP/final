  ...
  <main>
    <form class="container" @submit.prevent="addQuestion">
      ...
      <div class="row" style="display: flex; gap: 40px">
        <div class="col-12">
          <h5 style="color: gray; font-weight: 400">
      ...
      <div class="row">
        <div class="col-12">
          <div class="input-group mb-3">
            <input
              class="text-area text-box multi-line w-100"
              data-val="true"
              ...
              cols="200"
              rows="3"
              style="border-color: #d3d3d3; border-radius: 5px"
      ...
      <div class="row">
        <div class="col-12">
          <div class="input-group mb-3">
            <textarea
              class="text-area text-box multi-line yy"
              data-val="true"
              data-val-length="Maximum = 2045 characters"
              data-val-length-max="10000"
              id="info"
