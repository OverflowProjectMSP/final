    ...
    data() {
        return {
            faqs: [
                ...
                в тупик - UpFlow к вашим услугам! Здесь вы можете найти людей, готовых помочь вам в трудную минуту, 
                ...
                рядом с вашим вопрос. Нажмите на нее, внесите необходимые изменения и сохраните отредактированное сообщение.`,
                    isHide: true
                },
                {
